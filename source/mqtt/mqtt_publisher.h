 ...
 * Include guard
 ******************************************************************************/
#ifndef PUBLISHER_TASK_H
#define PUBLISHER_TASK_H
...
/* Structure used for storing node data */
typedef struct
{
    uint16_t node_status[2u];
    uint16_t light_level[2u];
    uint16_t switch_level[2u];
}node_data_t;
