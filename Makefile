...
APPNAME=mtb-example-btstack-freertos-wifi-gateway
...
# added to the build
#
COMPONENTS=FREERTOS LWIP MBEDTLS SECURE_SOCKETS RTOS_AWARE WICED_BLE
...
DEFINES=$(MBEDTLSFLAGS) CYBSP_WIFI_CAPABLE \
			...
			WICED_BT_TRACE_ENABLE=TRUE \
			WICED_BT_MESH_TRACE_ENABLE=FALSE

ifeq ($(WICED_BT_MESH_TRACE_ENABLE),TRUE)		
