...
#define MQTT_PUB_TOPIC                    "$aws/things/IOT_GATEWAY/shadow/name/mesh_devices/update"
#define MQTT_SUB_TOPIC                    "IOT_GATEWAY/mesh_devices"
 ...
 * node and get the node status.
 */
#define MQTT_DEVICE_GET_NODE_MESSAGE      "GET NODE"
#define MQTT_DEVICE_SET_LIGHT_MESSAGE     "SET LIGHT X"
